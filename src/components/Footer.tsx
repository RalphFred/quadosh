          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:+2348057820833" className="hover:text-primary transition-colors duration-200">
                                            +234 805 782 0833
                                        </a>
              </div>
              <div className="flex items-center space-x-3">
                <Mail size={18} className="text-primary" />
                <a href="mailto:qadoshmedical@gmail.com" className="hover:text-primary transition-colors duration-200">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            ...
            <div className="text-center lg:text-left">
              <p className="text-gray-300 max-w-2xl">
                Bringing quality healthcare directly to you - delivering personalized medical services in the comfort of your home, office, and community.
              </p>
            </div>
